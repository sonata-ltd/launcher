...
import { WindowManager } from "lib/windowManager/WindowManager";
...
const App: Component = (props: any) => {
	...
	const [reconnectScreenTriggerFn, setReconnectScreenTriggerFn] =
		createSignal<(() => Promise<void>) | undefined>();
				...
				<WebSocketProvider>
					<DBDataProvider>
						<InstancesStateProvider>
							<AppServicesHandler
								setWSAllConnected={setWSAllConnected}
								reconnectScreenThenFn={reconnectScreenTriggerFn}
							/>
							<Show
								when={wsAllConnected()}
								fallback={
