...
export const OverviewPage = (props: InstancePageProps) => {
	...
	const [data, { refetch }] = createResource(
		...
		async (id) => {
			...
			if (parsed.success) {
				const safeOption = instanceFieldsSchema.parse(
					parsed.payload.option,
				);
	...
	return (
		<>
			...
			<OptionsSection label="Delete Instance" gapContent>
				<DescriptionText>
					Permanently deletes an instance from your device, including
					your worlds, configs, and all installed content. Be careful,
					as once you delete a instance there is no way to recover it.
				</DescriptionText>
