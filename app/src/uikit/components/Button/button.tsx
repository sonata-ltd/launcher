		...
		<>
			...
			>
				<button
					...
					classList={{
						[styles.primary]:
							getButtonType() === ButtonTypes.primary,
						[styles.secondary]:
							getButtonType() === ButtonTypes.secondary,
						[styles.tertiary]:
							getButtonType() === ButtonTypes.tertiary,
						[styles.acryl]: getButtonType() === ButtonTypes.acryl,
						[styles.disabled]: props.disabled,
						[styles.destructive]: props.destructive,
						[styles.icon]: props.icon,
						[styles.sm]:
							props.size === ButtonSizes.sm || !props.size,
						[styles.md]: props.size === ButtonSizes.md,
						[styles.lg]: props.size === ButtonSizes.lg,
